...
m.map("n", "<c-g>", "<CMD>BufferLinePick<CR>")
m.map("n", "gt", "<CMD>BufferLineCycleNext<CR>")
m.map("n", "gT", "<CMD>BufferLineCyclePrev<CR>")
m.map("n", "<A-k>", "<CMD>BufferLineCycleNext<CR>")
m.map("n", "<A-j>", "<CMD>BufferLineCyclePrev<CR>")
m.map("n", "<leader>tcr", "<CMD>BufferLineCloseRight<CR>")
m.map("n", "<leader>ts", "<CMD>BufferLinePick<CR>")
